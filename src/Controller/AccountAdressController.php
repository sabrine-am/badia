...
class AccountAdressController extends AbstractController
{
    ...
    /**
     * @Route("/account/add-an-adress", name="account_adress_add")
     */
    ...
    /**
     * @Route("/account/edit-an-adress/{id}", name="account_adress_edit")
     */
    public function edit(Request $request, $id): Response
    {
     ...
     /**
     * @Route("/account/delete-an-adress/{id}", name="account_adress_delete")
     */
